...
abstract class BasePagerAdapter<T>(
    ...
    abstract var itemsList: MutableList<*>
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) = viewHolderCallback(holder, itemsList as MutableList<T>, position)
