...
data class AudioClipData(
    ...
    companion object {
         ...
         */
        val diffCallback = object : DiffUtil.ItemCallback<AudioClipData>() {
            override fun areItemsTheSame(
                oldItem: AudioClipData,
                newItem: AudioClipData
            ): Boolean =
                oldItem.mediaId == newItem.mediaId

            override fun areContentsTheSame(oldItem: AudioClipData, newItem: AudioClipData) =
                oldItem.mediaId == newItem.mediaId && oldItem.playbackRes == newItem.playbackRes

            override fun getChangePayload(oldItem: AudioClipData, newItem: AudioClipData) =
